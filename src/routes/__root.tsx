...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Shiva Gauri Traders — Women's Fashion in Hetauda" },
      {
        name: "description",
        content:
          "Family-owned women's clothing house in Hetauda offering sarees, kurtis, dresses, salwar suits and shawls.",
      },
